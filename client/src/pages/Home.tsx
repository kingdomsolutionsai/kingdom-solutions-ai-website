...
export default function Home() {
  usePageMeta({
    title:
      "Kingdom Solutions AI™ — Strategic AI Systems for High-Capacity Leaders",
    description:
      "Kingdom Solutions AI™ helps coaches, founders, consultants, and executives build strategic AI systems for clarity, capacity, and intelligent support. Premium advisory by Tabitha Rector.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8 lg:col-start-1">
              ...
              <p className="font-body text-lg lg:text-xl text-charcoal-light leading-[1.7] max-w-2xl mb-12 fade-up">
                Kingdom Solutions AI™ helps new coaches, founders, consultants,
                executives, and high-capacity leaders clarify their message,
                protect their time, and install the right AI-supported systems
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20">
            ...
            <div className="lg:col-span-4 lg:col-start-8 flex items-end fade-up">
              <p className="font-body text-base text-charcoal-light leading-relaxed">
                If you already know what you need, go directly to the right
                system. If you are not sure where time, clarity, follow-up, or
                revenue is leaking, start with the Capacity Leak Audit™.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 border border-taupe/60 fade-up">
            ...
            <div className="group p-10 lg:p-12 transition-colors duration-500 hover:bg-cream-dark/40">
              ...
              <p className="font-body text-sm text-charcoal-light leading-[1.8] mb-10">
                For leaders who know something is leaking, whether time,
                clarity, focus, follow-up, capacity, or revenue, but need help
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 lg:col-start-7 fade-up">
              ...
              <p className="font-body text-base text-charcoal-light leading-[1.8] mb-8">
                Today, she helps overwhelmed leaders use AI intentionally, not
                to replace human connection, but to create more space for what
                matters most.
              </p>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="max-w-2xl mx-auto text-center fade-up">
            ...
            <p className="font-body text-lg text-charcoal-light leading-relaxed mb-12">
              Whether you need clarity, capacity, or a strategic diagnosis, the
              first step is always simple.
            </p>
