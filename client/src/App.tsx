  ...
  return (
    <Layout>
      <Switch>
        ...
        <Route
          path="/capacity-leak-audit"
          component={CapacityLeakAudit}
        />

        <Route
          path="/clarity-pro"
          component={ClarityPro}
        />
        ...
        <Route
          path="/entrepreneur-assessment"
          component={EntrepreneurAssessment}
        />
